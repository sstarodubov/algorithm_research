...
assert 0 == Solution().maxProbability(n=3, edges=[[0, 1]], succProb=[0.5], start=0, end=2)
assert 0.3 == Solution().maxProbability(n=3, edges=[[0, 1], [1, 2], [0, 2]], succProb=[0.5, 0.5, 0.3], start=0, end=2)
assert 0.25 == Solution().maxProbability(n=3, edges=[[0, 1], [1, 2], [0, 2]], succProb=[0.5, 0.5, 0.2], start=0, end=2)
